...
const NotificationPreview = ({
  ...
  return (
    <div className="w-full h-full flex flex-col bg-slate-900 rounded-xl p-4 shadow-lg">
      <div className="mb-4">
        ...
        >
          ...
          <TabsContent value="sms" className="mt-4">
            <Card className="bg-slate-100 dark:bg-slate-800 border-0 shadow-md max-w-[350px] mx-auto">
              <CardContent className="p-0">
                <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-3">
                  <div className="flex justify-between items-center">
                    <div className="text-white text-sm font-medium">
                ...
                <div className="p-4">
                  <div className="bg-indigo-500 text-white p-3 rounded-lg rounded-bl-none mb-3 max-w-[85%] text-sm">
                    {personalizedContent}
                  </div>
